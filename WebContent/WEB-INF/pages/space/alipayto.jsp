	...
	<%
		//request.setCharacterEncoding("UTF-8");
	       ...
	       // String subject = new String(request.getParameter("aliorder").getBytes("ISO-8859-1"),"GBK");
	        ...
	        String exter_invoke_ip= request.getRemoteAddr();//获取客户端的IP地址，建议：编写获取客户端IP地址的程序
	        //如：
	        ...
	        //扩展功能参数——其他
	        String extra_common_param =(String)request.getAttribute("extra_common_param");//自定义参数，可存放任何内容（除=、&等特殊字符外），不会显示在页面上
	        String buyer_email =(String)request.getAttribute("buyer_email");;					//默认买家支付宝账号
