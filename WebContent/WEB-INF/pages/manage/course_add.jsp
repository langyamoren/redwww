...
<table width="800"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="780" align="left" valign="middle" style="font-size:16px; font-weight:bold;">增加新课程</td>
  </tr>
</table>
<s:form namespace="/mred/course" action="addSave_course">
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" id="addCourseType">
  <tr>
    ...
    <td width="294"><s:textfield name="course.title" cssClass="redInput" cssStyle="width:260px;"/></td>
  ...
  <tr>
    ...
    <td colspan="5" align="left" valign="middle"><s:submit value="增加课程" cssClass="redButton"/></td>
  </tr>
</table>
</s:form>
<!-- 错误信息报告 -->
