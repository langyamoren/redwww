...
<body>
<center>
	<br/><div class="titleText">增加管理员</div><br/>
	<div class="formDiv">
	  <s:form action="admin_add" onsubmit="checkPrim()">	
		<table width="579" align="center" border="0" cellpadding="0" cellspacing="0">
		  <tr>
		    <td width="71" height="40" align="right">用户名：</td>
		    <td width="179" align="left"><s:textfield name="admin.adminName" size="22" cssClass="redInput"/></td>
		    <td width="71" align="right">密码：</td>
		    <td width="258" align="left"><s:textfield name="admin.adminPwd" size="22" cssClass="redInput"/></td>		    	    
		  </tr>
		  <tr>
		    <td align="right" valign="top">权限：</td>
		    <td valign="top" colspan="3"><table width="507" cellspacing="0" cellpadding="0">
		        <tr>
		        ...
		        <tr>
		          ...
		          <td width="13"><input type="checkbox" id="prim14" name="prim14" value="true" checked="checked"/></td>
		          <td align="left" valign="middle">14、欢迎页</td>
		          <td width="14"><input type="checkbox"  id="prim15" name="prim15" value="true"  checked="checked"/></td>
		...
		<br/>
		  <div align="center">
			<s:submit value="增加" cssClass="redButton"/>&nbsp;
			<s:reset value="重置" cssClass="redButton"/>&nbsp;
		    <input type="button" name="btn_ret" value="返回" onClick="window.location='mred/admin/admin_browse';" class="redButton">
