...
<table width="800"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="789" style="font-size:16px; font-weight:bold;">修改下载</td>
  </tr>
</table>
<s:form namespace="/mred/download" method="post" action="updateSave_download">
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="60" height="30" align="right">标题：</td>
    <td width="359" height="30" align="left" valign="middle">
	 <s:token name="download_update_token"></s:token>
	<s:hidden name="download.id"></s:hidden>
  ...
  <tr>
	...
	<s:submit value="修改下载" cssClass="redButton"/>
	</td>
  </tr>
</table>
</s:form>
