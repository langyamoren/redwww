...
<s:form namespace="/mred/chapter" action="addSave_chapter" method="post">
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
  ...
  <tr>
    ...
    <td height="40" colspan="3" align="left" valign="middle"><s:submit value="增加新内容" cssClass="redButton" cssStyle="height:30px; line-height:30px;" /></td>
  </tr>
</table>
</s:form>
<!-- 错误信息报告 -->
