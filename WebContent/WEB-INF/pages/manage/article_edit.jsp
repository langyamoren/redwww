...
<body>
<h1 style="font-size:16px; margin:10px;">修改文章</h1>

<s:form action="updateSave_article" namespace="/mred/article" method="post">
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" id="showC">
  ...
  <tr>
    ...
    <table width="389" height="32" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <s:select name="article.articleType.id" list="articleType" listKey="id" listValue="name" headerKey="0" headerValue="请选择分类"/>
    ...
    <s:textfield name="article.fromdesc" cssClass="redInput" cssStyle="width:145px;" value="本站转载"></s:textfield>
  ...
  <tr>
    <td align="right">&nbsp;</td>
    <td colspan="3"><s:submit value="修改文章" cssClass="redButton"></s:submit></td>
  </tr>
</table>
</s:form>
<!-- 错误信息报告 -->
