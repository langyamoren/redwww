...
<body>
<s:form namespace="/mred/article_type" action="add_article_type">
<table width="600" height="30" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="185"><s:textfield name="articleType.name"  cssClass="redInput" ></s:textfield></td>
...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" id="articleTypeList">
  ...
  <s:iterator value="atList" status="state">
  <s:form namespace="/mred/article_type">
  <tr>
    <td height="30" align="center" valign="middle">
    <s:hidden name="articleType.id" value="%{id}"></s:hidden>
    <s:property value="#state.index+1"/></td>
    <td height="30" align="left" valign="middle">
    <s:textfield name="articleType.name" value="%{name}" cssClass="redInput" cssStyle="width:120px; margin-left:10px;"/></td>
    <td height="30" align="center" valign="middle">
    <s:textfield name="articleType.sorts" value="%{sorts}" cssClass="redInput"  cssStyle="width:80px; margin-left:10px;"/></td>
    <td height="30" align="center" valign="middle">
    <s:submit action="update_article_type" value="修改" cssClass="redButton"/>
    </td>
    <td height="30" align="center" valign="middle">
    <s:submit action="delete_article_type" value="删除" cssClass="redButton"/>
    </td>
  </tr>
  </s:form>
  </s:iterator>
