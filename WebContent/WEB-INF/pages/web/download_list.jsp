...
<head>
<title>软件下载-<s:property value="downType.name"/></title>
<style type="text/css">
...
<div class="ariticle_top">
       <div class="tit_list">
           <h2><s:property value="downType.name"/></h2>
		   
	   </div>
       <ul>
                <s:iterator value="downloadList" status="stat">
				  <li>
				  <a  target="_blank" href="<s:text name="red.html.down.path"></s:text>d<s:property value="downType.id"/><s:property value="id"/>.html"><s:property value="#stat.index+1"/>&nbsp;<s:property value="title"/></a>
